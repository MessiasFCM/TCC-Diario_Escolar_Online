<?php
    ...
    unset(
		$_SESSION['dataEstudante'],
	);

    $DataEstudante = $_POST["idAnoLetivoSelect"];
    $_SESSION['dataEstudante']=$DataEstudante;
...
<head>
    ...
    <script>
        ...
        function listar_registros(pagina, qtd_result_pg) {
            ...
            $.post('listar/listarHistorico.php', dados, function(retorna) { //envia os dados via post

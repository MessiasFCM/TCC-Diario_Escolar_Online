        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800"> Gerenciar Provas</h1>
                    <p class="mb-4"></p>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-800">Dados das provas</h6>
                        </div>
                        <div class="modal-body">
                            <form action="gerenciaProvasEscolhidas.php" method="post">
                                ...
                                <select class="custom-select custom-select-sm form-control form-control-sm mb-3" name="idEtapaSelect" id="idMateriaSelect">
                                    ...
                                    ?>
                                        <option value="<?php echo $exibirMateria["idEtapa"]; ?>"><?php echo $exibirMateria["NomeEtapa"] ?> - <?php echo $exibirMateria["AnoEtapa"] ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>

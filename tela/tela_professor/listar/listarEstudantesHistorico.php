<?php
    ...
    $IdadeEscolarMateria=$_SESSION['idadeEscolar'];
                ...
                <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tfoot>
                        <th colspan="4" style="text-align:center;width:100px;">Voltar 
                            ...
                            &nbsp;&nbsp;&nbsp;Baixar Histórico
                            <a href="../../gerarPDFHistoricoSeparadoProfessor.php"  type="submit" class="btn btn-info btn-xs dt-add">

<?php
    ...
    unset(
		$_SESSION['RegistroAcademicoEstudante'],
	);
    
    $RegistroAcademico = $_GET["RegistroAcademico"];
    $_SESSION['RegistroAcademicoEstudante']=$RegistroAcademico;
...
<head>
    ...
    <script>
        ...
        function listar_registros(pagina, qtd_result_pg) {
            ...
            $.post('listar/listarEstudanteHistorico.php', dados, function(retorna) { //envia os dados via post

<?php
    ...
    $idAnoLetivo = $_POST["idAnoLetivoSelect"];
    $_SESSION['idAnoLetivo']=$idAnoLetivo;
...
<head>
    ...
    <script>
        ...
        function listar_registros(pagina, qtd_result_pg) {
            ...
            $.post("listar/listarEstudanteHistoricoSelecionar.php?RegistroAcademico=<?php echo $RegistroAcademico ?>", dados, function(retorna) { //envia os dados via post

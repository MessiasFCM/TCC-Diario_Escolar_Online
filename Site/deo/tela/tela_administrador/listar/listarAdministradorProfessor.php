...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="modal-body">
            ...
            $sql = "SELECT * 
                FROM Professor
                WHERE NomeProfessor like '%$pesquisa%'
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="../../php/php_crud_atualizar/atualizarProfessor.php?idProfessor=<?php echo $exibir["idProfessor"] ?>" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="password" value="" class="form-control form-control-user" name="txtSenhaProfessor2"  id="txtSenhaProfessor2"  required placeholder="Insira uma senha caso deseje alterá-la">
                                                    </div>
                                                    <hr>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../../php/php_crud_inserir/inserirProfessor.php" method="post">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" name="txtnomeProfessor" id="txtnomeProfessor" aria-describedby="nomeProfessor" placeholder="Insira o nome completo">
                            </div>
                            <div class="form-group">
                                <input type="email" class="form-control form-control-user" name="txtemailProfessor" id="txtemailProfessor" aria-describedby="emailProfessor" placeholder="Insira o Email">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" name="txtContatoProfessor" id="txtContatoProfessor" aria-describedby="contatoProfessor" placeholder="Insira o contato do professor">
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control form-control-user" name="txtsenhaProfessor"  id="senhaProfessor" placeholder="Insira a senha">
                            </div>

        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800"> Matérias Separadas</h1>
                    <p class="mb-4"></p>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-800">Visualizar Notas por Matéria</h6>
                        </div>
                        <div class="modal-body">
                                    ...
                                    <form action="materias.php" method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                ...
                                                <select class="custom-select custom-select-sm form-control form-control-sm mb-3" name="idAnoLetivoSelect" id="idAnoLetivoSelect" onchange="Carregar()">
                                            ...
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <button class="btn btn-primary btn-border btn-sm" type="submit" name="enviar" value="Pesquisar">Carregar</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <?php 
                            if(isset($_POST["idAnoLetivoSelect"])){
                                $anoEscolarSelecionado = $_POST["idAnoLetivoSelect"]; 
                                $string = null;
                                $array = null;
                                $string = $exibirEstudante["VerificacaoEstudante"];
                                $array = explode(' - ', $string);
                                if($anoEscolarSelecionado==$array[0]){
                                    $anoEscolar = $array[0];
                                    $idadeEscolar = $array[1];
                                    $situacaoEscolarGeral = $array[2];
                                }elseif($anoEscolarSelecionado==$array[3]){
                                    $anoEscolar = $array[3];
                                    $idadeEscolar = $array[4];
                                    $situacaoEscolarGeral = $array[5];
                                }elseif($anoEscolarSelecionado==$array[6]){
                                    $anoEscolar = $array[6];
                                    $idadeEscolar = $array[7];
                                    $situacaoEscolarGeral = $array[8];
                                }elseif($anoEscolarSelecionado==$array[9]){
                                    $anoEscolar = $array[9];
                                    $idadeEscolar = $array[10];
                                    $situacaoEscolarGeral = $array[11];
                                }elseif($anoEscolarSelecionado==$array[12]){
                                    $anoEscolar = $array[12];
                                    $idadeEscolar = $array[13];
                                    $situacaoEscolarGeral = $array[14];
                                }elseif($anoEscolarSelecionado==$array[15]){
                                    $anoEscolar = $array[15];
                                    $idadeEscolar = $array[16];
                                    $situacaoEscolarGeral = $array[17];
                                }elseif($anoEscolarSelecionado==$array[18]){
                                    $anoEscolar = $array[18];
                                    $idadeEscolar = $array[19];
                                    $situacaoEscolarGeral = $array[20];
                                }elseif($anoEscolarSelecionado==$array[21]){
                                    $anoEscolar = $array[21];
                                    $idadeEscolar = $array[22];
                                    $situacaoEscolarGeral = $array[23];
                                }elseif($anoEscolarSelecionado==$array[24]){
                                    $anoEscolar = $array[24];
                                    $idadeEscolar = $array[25];
                                    $situacaoEscolarGeral = $array[26];
                                }elseif($anoEscolarSelecionado==$array[27]){
                                    $anoEscolar = $array[27];
                                    $idadeEscolar = $array[28];
                                    $situacaoEscolarGeral = $array[29];
                                }elseif($anoEscolarSelecionado==$array[30]){
                                    $anoEscolar = $array[30];
                                    $idadeEscolar = $array[31];
                                    $situacaoEscolarGeral = $array[32];
                                }elseif($anoEscolarSelecionado==$array[33]){
                                    $anoEscolar = $array[33];
                                    $idadeEscolar = $array[34];
                                    $situacaoEscolarGeral = $array[35];
                                }elseif($anoEscolarSelecionado==$array[36]){
                                    $anoEscolar = $array[36];
                                    $idadeEscolar = $array[37];
                                    $situacaoEscolarGeral = $array[38];
                                }elseif($anoEscolarSelecionado==$array[39]){
                                    $anoEscolar = $array[39];
                                    $idadeEscolar = $array[40];
                                    $situacaoEscolarGeral = $array[41];
                                }elseif($anoEscolarSelecionado==$array[42]){
                                    $anoEscolar = $array[42];
                                    $idadeEscolar = $array[43];
                                    $situacaoEscolarGeral = $array[44];
                                }
                            ...
                            ?>
                            <form action="materiaAnoSelecionado.php?anoEscolar=<?php echo $anoEscolar?>&idadeEscolar=<?php echo $idadeEscolar?>&situacaoEscolarGeral=<?php echo $situacaoEscolarGeral?>" method="post">
                                <h6><b>Selecione a matéria</b>&nbsp;</h6>
                                <select class="custom-select custom-select-sm form-control form-control-sm mb-3" name="idMateriaSelect" id="idMateriaSelect">
                                    ...
                                    $Materia = $conn->query($sql3);
                                    if ($Materia->num_rows >= 0) {
                                        while ($exibirMateria = $Materia->fetch_assoc()){?>
                                            <option value="<?php echo $exibirMateria["idMateria"]?>"><?php echo $exibirMateria["NomeMateria"] ?> - <?php echo $idadeEscolar ?></option>
                                        <?php
                                        }
                                    }
                                    ?>

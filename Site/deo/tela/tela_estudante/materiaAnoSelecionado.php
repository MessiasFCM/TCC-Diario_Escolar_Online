<?php
    ...
    unset(
        ...
        $_SESSION['situacaoEscolarGeral'],
        $_SESSION['idMateriaSelect']
	);
    
    $anoEscolar = $_GET["anoEscolar"];
    $idadeEscolar = $_GET["idadeEscolar"];
    $situacaoEscolarGeral = $_GET["situacaoEscolarGeral"];
    $idMateriaSelect = $_POST["idMateriaSelect"];

    $_SESSION['anoEscolar'] = $anoEscolar;
    $_SESSION['idadeEscolar'] = $idadeEscolar;
    $_SESSION['situacaoEscolarGeral'] = $situacaoEscolarGeral;
    $_SESSION['idMateriaSelect'] = $idMateriaSelect;
...
<head>
    ...
    <script>
        ...
        function listar_registros(pagina, qtd_result_pg) {
            ...
            $.post('listar/listarMaterias.php', dados, function(retorna) { //envia os dados via post

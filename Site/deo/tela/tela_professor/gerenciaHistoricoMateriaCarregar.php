<?php
    ...
    $IdadeEscolarMateria = $_GET["idadeEscolar"];
    $idMateria = $_GET["idMateria"];

    $_SESSION['RegistroAcademico']=$RegistroAcademico;
    $_SESSION['idadeEscolar']=$IdadeEscolarMateria;
...
<head>
    ...
    <script>
        ...
        function listar_registros(pagina, qtd_result_pg) {
            ...
            $.post('listar/listarEstudantesHistorico.php', dados, function(retorna) { //envia os dados via post
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-800">Dados do histórico</h6>
                        </div>

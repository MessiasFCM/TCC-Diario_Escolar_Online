<?php
    ...
    if (isset($_GET["idEtapa"]) && isset($_GET["idMateria"]) && isset($_GET ["data"])) {
...
<head>
    ...
    <script>
        ...
        function listar_registros(pagina, qtd_result_pg) {
            ...
            $.post('listar/listarAusenciaEstudante.php', dados, function(retorna) { //envia os dados via post

        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php
                if($_SESSION['usuarioNivelDeAcesso'] == '2'){
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="gerenciaNotas.php">
                            <i class="mdi mdi-book"></i>
                            <span>Gerenciar notas</span></a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="gerenciaAusencia.php">
                            <i class="mdi mdi-book"></i>
                            <span>Gerenciar ausência</span></a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="gerenciaHistoricoMateria.php">
                            <i class="mdi mdi-book"></i>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800"> Gerenciar Ausência</h1>
                    <p class="mb-4"></p>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-800">Dados de ausência</h6>
                        </div>
                        <div class="modal-body">
                            <form action="gerenciaAusenciaEstudante.php" method="post">
                                <h6><b>Selecione a etapa</b>&nbsp;</h6>
                                <select class="custom-select custom-select-sm form-control form-control-sm mb-3" name="idEtapaSelect" id="idMateriaSelect">
                                    <option selected disabled hidden>Etapa</option>
                                    <?php
                                    ...
                                    $sqlEtapa = "SELECT *
                                        FROM Etapa
                                        WHERE InstituicaoEtapa_IdInstituicao = $InstituicaoProfessor_IdInstituicao
                                        AND AnoEtapa = $ano";
                                    $Etapa = $conn->query($sqlEtapa);
                                    
                                    while ($exibirEtapa= $Etapa->fetch_assoc()) {
                                    ?>
                                        <option value="<?php echo $exibirEtapa["idEtapa"]; ?>"><?php echo $exibirEtapa["NomeEtapa"] ?> - <?php echo $exibirEtapa["AnoEtapa"] ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                                <h6><b>Selecione a matéria</b>&nbsp;</h6>
                                <select class="custom-select custom-select-sm form-control form-control-sm" name="idMateriaSelect" id="idMateriaSelect">
                                    ...
                                    ?>
                                        <option value="<?php echo $exibirMateria["idMateria"]; ?>"><?php echo $exibirMateria["NomeMateria"] ?> - <?php echo $exibirMateria["IdadeEscolarMateria"]?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                                <hr>
                                <h6><b>Selecione a data</b>&nbsp;</h6>
                                <div class="form-group">
                                    <input type="date" class="form-control form-control-user" max="<?php echo $ano ?>-12-31" min="<?php echo $ano ?>-01-01" name="txtDataAusencia" id="txtDataAusencia" aria-describedby="DataProva" placeholder="Insira a data desejada">
                                </div>
                                <hr>

<?php
    ...
    unset(
		$_SESSION['Etapa_idEtapa'],
		$_SESSION['Materia_idMateria'],
	);
    ...
    if (isset($_GET["Etapa_idEtapa"]) && isset($_GET["Materia_idMateria"])) {
        ...
        $_SESSION['Etapa_idEtapa']=$idEtapa;
        $_SESSION['Materia_idMateria']=$idMateria;
    }else{
        $idEtapa = $_POST ["idEtapaSelect"];
        $idMateria = $_POST ["idMateriaSelect"];

        $_SESSION['idEtapaSelect']=$idEtapa;
        $_SESSION['idMateriaSelect']=$idMateria;
...
<head>
    ...
    <script>
        ...
        function listar_registros(pagina, qtd_result_pg) {
            ...
            $.post('listar/listarProvasEscolhidas.php', dados, function(retorna) { //envia os dados via post
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800"> Gerenciar Estudantes</h1>
                    <p class="mb-4"></p>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray-800">Dados dos estudantes</h6>
                        </div>
